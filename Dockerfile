...
ADD https://github.com/dashpay/dash/releases/download/v0.12.1.3/dashcore-0.12.1.3-linux64.tar.gz /tmp/
RUN cd /tmp && tar xvfz dashcore-0.12.1.3-linux64.tar.gz && cp -R dashcore-0.12.1/bin/* /usr/bin && mkdir /var/run/dashd && \
