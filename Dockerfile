...
ADD https://github.com/just-containers/s6-overlay/releases/download/v1.17.2.0/s6-overlay-amd64.tar.gz \
    https://github.com/dashpay/dash/releases/download/v0.12.1.3/dashcore-0.12.1.3-linux64.tar.gz \
    /tmp/

RUN tar xzf /tmp/s6-overlay-amd64.tar.gz -C / && \
    cd /tmp && tar xvfz dashcore-0.12.1.3-linux64.tar.gz && cp -R dashcore-0.12.1/bin/* /usr/bin && mkdir /var/run/dashd && \
